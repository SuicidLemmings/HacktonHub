...
public class RepeatingBackground : MonoBehaviour 
{
	...
	private void Update()
	{
        ...
        if (transform.position.x < -groundHorizontalLength * transform.localScale.x * 0.5f)
		{
	...
	private void RepositionBackground()
	{
		...
		Vector2 groundOffSet = new Vector2(groundHorizontalLength * transform.localScale.x * 2f * 0.499f, 0);
